                   ...
                   std::vector<ant>& ants, std::size_t& cpteur )
{
    ...
    // Parallélisation du déplacement des fourmis
    ...
    phen.do_evaporation(); // (Assumindo que você já colocou o #pragma omp parallel for lá dentro)

    auto t3 = clock_type::now();

    // ----- Mesure du temps de mise à jour des phéromones -----
    phen.update(); // Sequencial, apenas faz swap de ponteiros/buffers
